...
for person_dir in os.listdir("Images_multi"):
    person_id = person_dir  # Use the directory name as the person ID
    person_encodings = []
    for img_file in os.listdir(os.path.join("Images_multi", person_dir)):
        img_path = os.path.join("Images_multi", person_dir, img_file)
